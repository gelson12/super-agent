...
async def lifespan(app: FastAPI):
    ...
    _scheduler.add_job(_pro_token_keeper_job, "cron", hour=3, minute=0,
    ...
    _scheduler.start()
    _bg_log("CLI maintenance scheduler started (pro_keeper 03:00, gemini_keeper 04:00, watchdog 5min)", "boot")
